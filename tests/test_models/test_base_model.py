...
class test_basemodel(unittest.TestCase):
    ...
    def test_init(self):
        """
        Testing the initialization of the model class.
        """
    ...
    def test_str(self):
        """ test the str method of themodel"""
        i = self.value()
    ...
    def test_id(self):
        """ test id attr of the model"""
        new = self.value()
        self.assertEqual(type(new.id), str)

    def test_created_at(self):
        """ tests created at attr"""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """ tests updated at attr"""
        new = self.value()
